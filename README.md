...
A Python implementation of [CGAL Shape Regularization](https://doc.cgal.org/latest/Shape_regularization/) algorithms for regularizing line segments and closed contours.
